...
// This file describes the schema for the "shopifyAppInstallation" model, go to https://whatsapp-chat-button.gadget.app/edit to view/edit your model in Gadget
